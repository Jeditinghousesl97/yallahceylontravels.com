        ...
        if ($recipient !== '') {
            ...
            $htmlBody = '
                ...
                <table cellpadding="8" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;max-width:700px;">
                    <tr><td style="width:180px;"><strong>Name</strong></td><td>' . e($name) . '</td></tr>
                    <tr><td><strong>Email</strong></td><td>' . e($emailInput) . '</td></tr>
                    <tr><td><strong>Phone</strong></td><td>' . e($phoneInput !== '' ? $phoneInput : '-') . '</td></tr>
                    <tr><td><strong>Tour Type</strong></td><td>' . e($tourType !== '' ? $tourType : '-') . '</td></tr>
                    <tr><td><strong>Travel Date</strong></td><td>' . e($travelDate !== '' ? $travelDate : '-') . '</td></tr>
                    <tr><td><strong>Persons</strong></td><td>' . e($persons !== '' ? $persons : '-') . '</td></tr>
                    <tr><td><strong>Budget</strong></td><td>' . e($budget !== '' ? $budget : '-') . '</td></tr>
                    <tr><td><strong>IP Address</strong></td><td>' . e($_SERVER['REMOTE_ADDR'] ?? '-') . '</td></tr>
                    <tr><td valign="top"><strong>Message</strong></td><td>' . nl2br(e($message)) . '</td></tr>
                </table>
            ';
            $textBody = "New Contact Enquiry\n\n"
                ...
                . 'Tour Type: ' . ($tourType !== '' ? $tourType : '-') . "\n"
                . 'Travel Date: ' . ($travelDate !== '' ? $travelDate : '-') . "\n"
    ...
    <div class="contact-grid">
      ...
      <div class="contact-form-wrap reveal-left" id="contact-form">
        ...
        <form id="contactForm" method="POST" action="contact.php">
          ...
          <?php if ($turnstileSiteKey): ?>
            <div class="cf-turnstile" data-sitekey="<?= e($turnstileSiteKey) ?>" style="margin-bottom:16px"></div>
          <?php endif; ?>
