...
foreach ($s as $k => $v) {
    if (is_string($v)) {
        $legacyName   = 'Tour' . ' Serene' . ' Lanka';
        $legacyDomain = 'tour' . 'serene' . 'lanka' . '.com';
            ...
            <div class="frow c2">
              ...
              <div class="fgrp">
                ...
                <input type="text" name="site_phone" class="form-control"
                       value="<?= sv($s,'site_phone') ?>" placeholder="+94 77 577 5211"/>
              </div>
            </div>
            <div class="fgrp">
              ...
              <input type="text" name="site_whatsapp" class="form-control"
                     value="<?= sv($s,'site_whatsapp') ?>" placeholder="94775775211"/>
            </div>
            <div class="fgrp">
