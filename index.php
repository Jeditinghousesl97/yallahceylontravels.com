...
<head>
  ...
  <meta property="og:image"       content="<?= e(seoImageUrl('images/og-image.jpg')) ?>"/>
...
<section class="hero" id="home">
  ...
  <div class="hero-slides">
    <?php foreach ($slides as $slide): ?>
      ...
      >
        <?php if ($slideHasVideo): ?>
          <video class="hero-video" autoplay muted loop playsinline preload="metadata"<?= !empty($slide['image']) ? ' poster="'.e(imgUrl($slide['image'])).'"' : '' ?>>
            <source src="<?= e(!empty($slide['video_url']) ? $slide['video_url'] : siteUrl($slide['video'])) ?>"/>
          </video>
        <?php endif; ?>
      </div>
    <?php endforeach; ?>
        ...
        <?php foreach ($featuredTours as $t): ?>
          ...
          <div class="tour-card reveal">
            ...
            <div class="tour-body">
              ...
              <div class="tour-desc"><?= e(excerptWordsChars($t['short_desc'] ?? '', 28, 187)) ?></div>
